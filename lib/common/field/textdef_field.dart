...
enum TextdefFieldTheme { light, dark }
...
class TextdefField extends StatefulWidget {
  const TextdefField({
    ...
    this.textSinFieldTheme = TextdefFieldTheme.light,
    this.maxLength = 100,
  });
  ...
  final bool readOnly;
  final TextdefFieldTheme textSinFieldTheme;
  ...
  @override
  State<TextdefField> createState() => _TextSinFieldState();
}

class _TextSinFieldState extends State<TextdefField> {
  ...
  Color get _fillFieldColor {
    if (widget.textSinFieldTheme == TextdefFieldTheme.dark) {
      return AppColor.foregroundDividor;
    }
    return AppColor.backgroundCard;
  }
